document.addEventListener('DOMContentLoaded', function () {
  ...
  function showNextQuote(direction) {
    ...
    if ( carousel_heading_text_h2_idx < 0 ) 
      carousel_heading_text_h2_idx = 5;
    else if ( carousel_heading_text_h2_idx > 5 )
      carousel_heading_text_h2_idx = 0;
  ...
  $('.success-stories-carousel-headings .carousel-navigation .cur-carousel').text('01/06');
  ...
  $success_stories_carousel.on('select.flickity', function(event, index) { 
    $('.success-stories-carousel-headings .carousel-navigation .cur-carousel').text('0' + (index + 1) + '/06');
  });
